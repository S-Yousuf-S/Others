...
with col2:
    st.markdown(
        ...
        <div style="padding-top:10px;">
            <h1 style="margin-bottom:0;">Sensei</h1>
...
if dojo_mode:
    st.markdown(
        ...
        .stApp {
            background:
                radial-gradient(circle at top left, rgba(61,217,180,0.10), transparent 25%),
                radial-gradient(circle at bottom right, rgba(212,175,55,0.08), transparent 25%),
                linear-gradient(135deg, #101418 0%, #151A1F 50%, #0D1117 100%);
        ...
        .streamlit-expanderHeader {
            ...
            border: 1px solid rgba(61,217,180,0.10);
        }
